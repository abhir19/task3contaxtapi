        ...
        <Fragment>
            <div className="container Articleedit">
              ...
              <form onSubmit={onSubmit} autoComplete="off" style={{width:'90vw',marginLeft:'20px'}}>
                 <label >Title</label>
                <input className="form-control" name="Title" placeholder="Title" value={heading} onChange={(e) => setHeading(e.target.value)} required/><br />
                   <label >Length</label>  
                  < input className="form-control" name="Lengh" placeholder="Length" value={subHeading} onChange={(e) => setSubHeading(e.target.value)} required/><br /> 
